...
import com.jva.expression.exceptions.ExpressionException;
import com.jva.expression.ExpressionSolver;
...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.println("""
                Эта программа умеет вычислять математические выражения, состоящие из различных операций.
                Внутри выражения можно вызывать определенные функции
                В строке выражений также разрешено одно присваивание переменной.
                Также имеются константы.
                Например a=5*(sin(PI/3)+1)""");

        //Добавление пользовательской функции округления
        expressionSolver.trySetFunction("round", Program::round);
                ...
                case 2:
                    ...
                    while (isNotCorrectInput) {
                        ...
                        try {
                            ...
                            if (!expressionSolver.trySetVariable(name, value))
