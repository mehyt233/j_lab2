package com.jva.expression;

import java.util.*;
import java.util.function.Function;

import com.jva.expression.exceptions.*;
...
public class ExpressionSolver {
     ...
     * @return Значение результата выражения
     ...
     */
    public boolean trySetFunction(String name, Function<Double,Double> function) {
     ...
     * @return Результат операции
     */
    public boolean trySetVariable(String name, Double value){
    ...
    /**
     * Занимается вычислением выражения без присваиваний.
        ...
        for (int index = 0; index < tokens.size(); index++) {
            ...
            if(standartOperators.contains(token)){
                if(stack.size()>0 && !token.equals("(")){
                    ...
                    //по разному обрабатывает в зависимости от приоритета текущей операции, _ - унарный минус
